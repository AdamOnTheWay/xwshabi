...
<body>
	...
	<form action="" name="jiudianxiangqingxiugai" method="post">
		...
		<br>
		<input name="fangxing1" type="text" value="">
		<br>
		<input name="fangxing2" type="text" value="">
		<br>
		<input name="fangxing3" type="text" value="">
		<br>
		<input name="fangxing4" type="text" value="">
		<br>
		<input name="fangxing5" type="text" value="">
		<br>
		<input name="fangxing6" type="text" value="">
		<br>
		<input name="fangxing7" type="text" value="">
		<br>
		<input name="fangxing8" type="text" value="">
		<br>
		<br> 房型预定:
		<br>
		<br>
