...
<body>
	...
	<br>
	<br>
	<form action="<?php echo U('Index/background/hhjdxq');?>" name="jiudianxiangqingxiugai" method="post">
		酒店id&nbsp&nbsp
		<input name="haohuajiudianid" type="text" value="<?php echo ($ho["id"]); ?>" readonly="true">
		<br> 酒店名&nbsp&nbsp
		...
		<br>
		<input name="fangxing1" type="text" value="<?php echo ($ho["house1"]); ?>">
		<br>
		<input name="fangxing2" type="text" value="<?php echo ($ho["house2"]); ?>">
		<br>
		<input name="fangxing3" type="text" value="<?php echo ($ho["house3"]); ?>">
		<br>
		<input name="fangxing4" type="text" value="<?php echo ($ho["house4"]); ?>">
		<br>
		<input name="fangxing5" type="text" value="<?php echo ($ho["house5"]); ?>">
		<br>
		<input name="fangxing6" type="text" value="<?php echo ($ho["house6"]); ?>">
		<br>
		<input name="fangxing7" type="text" value="<?php echo ($ho["house7"]); ?>">
		<br>
		<input name="fangxing8" type="text" value="<?php echo ($ho["house8"]); ?>">
		<br>
		<br> 房型预定:
		<br>
		<br>
