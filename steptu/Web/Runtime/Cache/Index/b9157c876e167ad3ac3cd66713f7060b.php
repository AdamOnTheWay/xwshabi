...
<div class="quanbu">
    ...
    <div class="container">
        ...
        <div class="realContainer">
            <img src="../Public/images/aboutUs/logo.png"><span>一起合作</span>
            <div class="realAboutUs">
                <?php echo (htmlspecialchars_decode($coopration["cooperation"])); ?>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="bottomaboutus"><span class="bottombiao">关于游记</span><div class="bottomxuanxiang">
            <a href="<?php echo U('Index/aboutYouJi/aboutUs');?>">关于我们</a><br>
            <a href="<?php echo U('Index/aboutYouJi/contavtUs');?>">联系我们</a><br>
            <a href="<?php echo U('Index/aboutYouJi/cooperation');?>">一起合作</a><br>
            <a href="<?php echo U('Index/index/userLaws');?>">用户协议</a><br>
            <a href="<?php echo U('Index/index/recruit');?>">诚聘英才</a></div>
        </div>
    </div>
    ...
    <div class="severalBtn">
        <ul>
            <li><a href="<?php echo U('Index/aboutYouJi/aboutUs');?>">关于我们</a></li>
            <li><a href="<?php echo U('Index/aboutYouJi/contavtUs');?>">联系我们</a></li>
            <li><a href="<?php echo U('Index/aboutYouJi/cooperation');?>">一起合作</a></li>
            <li><a href="<?php echo U('Index/index/userLaws');?>">用户协议</a><br></li>
            <li><a href="<?php echo U('Index/index/recruit');?>">诚聘英才</a></li>
        </ul>
    </div>
</div>
