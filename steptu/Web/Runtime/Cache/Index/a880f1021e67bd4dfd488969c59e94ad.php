     ...
     <div style="position:fixed;right:10%;top:85%;"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=983872881&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:983872881:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a></div>
		...
		<div class="content">
			...
			<div style="position: absolute;left: 230px;top: 280px;height: 234px;width: 288px;display:block" id="zhuhaohuajieguo">
              <a href="<?php echo U('Index/travelStore/jiudian');?>?id=<?php echo ($hs[0]["id"]); ?>">
...
<a href="<?php echo U('Index/travelStore/jiudian');?>?id=<?php echo ($hs[1]["id"]); ?>">
...
<a href="<?php echo U('Index/travelStore/jiudian');?>?id=<?php echo ($hs[2]["id"]); ?>">
...
<a href="<?php echo U('Index/travelStore/jiudian');?>?id=<?php echo ($hs[3]["id"]); ?>">
