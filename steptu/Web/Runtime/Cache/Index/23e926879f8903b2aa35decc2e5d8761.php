	...
	<div class="container">
		<div class="mainboxreal">
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="travealThemeContent">  <!--从这里开始循环-->
					...
					<span style="color: #046bb3;font-size: 13px;height: 34px;width: 166px"><?php echo ($v["status"]); ?>：<?php echo ($v["name"]); ?></span><br/>
					<span style="color: #ff8004;font-size: 8px;height: 16px;width: 166px"><?php echo ($v["description"]); ?></span><br/>
