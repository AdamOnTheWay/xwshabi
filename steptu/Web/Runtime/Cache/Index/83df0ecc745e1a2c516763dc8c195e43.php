...
<br>
<br>
<form action="<?php echo U('Index/background/taocandingdan','','');?>" name="" method="post">套餐订单搜索
    <br> 套餐订单id
...
<br>
<br>
<div id="taocandingdanxinxi" style="display:none;">
    <form action="<?php echo U('');?>" name="" id="" method="">
        ...
        <input name="" type="text" value="">
        <br>订单包含人数
        成人数 <input type="number">
        儿童数<input type="number">
        <br/>联系人
...
<script type="text/javascript">
    ...
    $(".xiugai").click(function() {
        taocandingdanxinxi.style.display = "block";
