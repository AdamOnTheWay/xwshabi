...
<table border="1" cellspacing="10">
	...
	<tr ><tr>
    <td>活动id</td>
    <td id="time<?php echo ($u["id"]); ?>">活动时间</td>
    <td id="shifadi<?php echo ($u["id"]); ?>">活动始发地</td>
    <td id="mudidi<?php echo ($u["id"]); ?>">活动目的地</td>
    <td id="neirong<?php echo ($u["id"]); ?>">活动内容</td>
    <td id="zuidacanyu<?php echo ($u["id"]); ?>">最大参与人数</td>
    <td id="faqiren<?php echo ($u["id"]); ?>">发起人</td>
    <td id="huodongbeizhu<?php echo ($u["id"]); ?>">活动备注</td>
    <td style="cursor:pointer;" class="xiugai" name="活动id"><font size="3" color="red">修改</font></td>
    <td style="cursor:pointer;" name="活动id" class="shanchu" ><font size="3" color="red">删除</font></td></tr>
	</table>
	<div id="yonghuxinxi" style="display:none;">
<form action="" name="yonghuguanli" id="yonghuguanli" method="post">
	  活动id&nbsp&nbsp <input id="taocanid" type="text" value="" readonly="true"><br>
       	活动时间&nbsp&nbsp<input id="huodongshijian" name="huodongshijian" type="text" value="">按格式输入<br>
   	  活动始发地&nbsp&nbsp<input id="huodongshifadi" name="huodongshifadi" type="text" value=""><br>
       活动目的地&nbsp&nbsp<input id="huodongmudidi" name="huodongmudidi" type="text" value=""><br>
           活动内容 &nbsp  <textarea id="huodongneirong" name="huodongneirong" cols="29" rows="14" ></textarea><br>
              <br>
最大参与人数&nbsp&nbsp<input id="zuidacanyurenshu"name="zuidacanyurenshu" type="text" value=""><br>
发起人&nbsp&nbsp<input id="faqiren" name="faqiren" type="text" value="">按照格式填写<br>
活动备注&nbsp  <textarea id="huodongbeizhu" name="huodongbeizhu" cols="29" rows="14" ></textarea><br>
...
$(".xiugai").click(function(){
       ...
       $("#taocanid").val(changshi);
        ...
        $("#huodongmudidi").val($("#mudidi"+changshi).html());
         $("#huodongneirong").val($("#neirong"+changshi).html());
          $("#zuidacanyurenshu").val($("#zuidacanyu"+changshi).html());
           $("#faqiren").val($("#faqiren"+changshi).html());
            $("#huodongbeizhu").val($("#huodongbeizhu"+changshi).html());
})
