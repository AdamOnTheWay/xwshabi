...
<br><br>
<form action="" name="haohuajiudiansousuo" method="post">旅游超市酒店搜索<br>
...
<br> <br> <br>
<table border="1" cellspacing="10">
	<tr><td>旅游超市酒店id</td><td>旅游超市酒店名</td><td>	旅游超市价格</td><td>所在城市</td><td>所在区县</td><td>最早可入住日期</td><td>最晚可离店日期</td><td style="cursor:pointer;" id="zengjia"><font size="3" color="red">增加</font></td></tr>

	<!-- 以下是一层 name需要你渲染上去对应的套餐id-->
	<tr ><td>旅游超市酒店id</td><td>旅游超市酒店名</td><td>	旅游超市价格</td><td>所在城市</td><td>所在区县</td><td>最早可入住日期</td><td>最晚可离店日期</td><td style="cursor:pointer;" id="xiugai" name="旅游超市id"><font size="3" color="red">修改</font></td><td style="cursor:pointer;" name="套餐id" id="shanchu" ><font size="3" color="red">删除</font></td><td style="cursor:pointer;" onclick="window.open('<?php echo U('Index/background/jiudianxiangqing');?>');" ><font size="3" color="red" >详情及修改</font></td></tr>
	</table>


	<div id="yonghuxinxi" style="display:none;">
<form action="" name="yonghuguanli" id="yonghuguanli" method="post">
	  <div>旅游超市酒店id:&nbsp&nbsp</div><br>
   	旅游超市酒店名&nbsp&nbsp<input name="haohuajiudianming" type="text" value=""><br>
   	旅游超市酒店价格&nbsp&nbsp<input name="haohuajiudianjiage" type="text" value=""><br>
    旅游超市酒店所在地&nbsp&nbsp<br>
      <div class="info">
	<div>
