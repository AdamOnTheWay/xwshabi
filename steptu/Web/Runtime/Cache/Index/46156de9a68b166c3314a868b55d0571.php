...
<body>
	...
	<table border="1" cellspacing="10">
		...
		<?php if(is_array($content)): foreach($content as $key=>$u): ?><tr>
			...
			<td style="cursor:pointer;" class="xiugai" name="旅游<?php echo ($u["id"]); ?>">
	...
	<div id="yonghuxinxi" style="display:none;">
		<form action="<?php echo U('Index/background/lvyouadd');?>" name="yonghuguanli" id="yonghuguanli" method="post">
			旅游超市酒店id&nbsp&nbsp
			<input id="haohuajiudianid" name="haohuajiudianid" type="text" value="" readonly="true">
			<br> 旅游超市酒店名&nbsp&nbsp
