...
<body>
  ...
  <form action="" name="taocantupian" id="taocantupian" method="post">
...
<form action="" name="rilijiagesousuo" id="rilijiagesousuo" method="post">
  日期&nbsp&nbsp<input name="riqi" type="text" value=""> 日期请按照格式填写<br>
    价格&nbsp&nbsp<input name="jiage" type="text" value=""><br>
...
<tr><td>日期</td><td>价格</td><td style="cursor:pointer;" id="zengjia"><font size="3" color="red">增加</font></td></tr>
<!-- 这是一层的样式 -->
<tr><td>日期</td><td>价格</td><td style="cursor:pointer;" id="xiugai" name="日期"><font size="3" color="red">修改</font></td><td style="cursor:pointer;" name="日期" id="shanchu"><font size="3" color="red">删除</font></td></tr>
</table>
...
<br><br><br><br>
  <form action="" name="taocanxiangqingxiugai"  method="post">
套餐id&nbsp&nbsp<br><br>
套餐名&nbsp&nbsp<input name="taocanming" type="text" value=""><br><br>
优惠价&nbsp&nbsp<input name="youhuijia" type="text" value=""><br><br>
套餐说明:<br><br>
 <!-- 加载编辑器的容器 -->
