...
<br><h3>位置管理，城市名和区县可重复添加</h3>
<br><br>
位置查询
<form action="" name="weizhichaxun" id="weizhichaxun" method="post">
	ID&nbsp&nbsp<input name="ID" type="text" value=""><br>
	城市名&nbsp&nbsp<input name="chengshiming" type="text" value=""><br>
	区县名&nbsp&nbsp<input name="quxianming" type="text" value=""><br>
	景点&nbsp&nbsp<input name="jingdian" type="text" value=""><br>
    机场火车站&nbsp&nbsp<input name="jichanghuochezhan" type="text" value=""><br>
   商业区&nbsp&nbsp<input name="shangyequ" type="text" value=""><br>
   <input type="submit" value="搜索" />
	</form>

<br><br><br>
<table border="1" cellspacing="10">
<tr><td>id</td><td>城市名</td><td>区县</td><td>景点</td><td>机场火车站</td><td>商业区</td><td style="cursor:pointer;" id="zengjia"><font size="3" color="red">增加</font></td></tr>

<!-- 以下是一层 -->
<tr><td>id</td><td>城市名</td><td>区县</td><td>景点</td><td>机场火车站</td><td>商业区</td><td style="cursor:pointer;" id="xiugai" name="city表id"><font size="3" color="red">修改</font></td><td style="cursor:pointer;" name="city表id" id="shanchu" ><font size="3" color="red">删除</font></td></tr>
