...
<br><br><br>
<h3>吃管理</h3>
	<form action="" name="chisousuo" method="post">吃店搜索
	...
	<div id="yonghuxinxi" style="display:none;">
		<form action="" name="yonghuguanli" id="yonghuguanli" method="post">
			吃店id&nbsp&nbsp <input id="chidianid" type="text" value="" readonly="true">
			<br> 吃店名&nbsp&nbsp
			...
			<br> 吃店电话&nbsp&nbsp
			<input id="chidiandianhua" name="youhuijia" type="text" value="">
		   <br>
