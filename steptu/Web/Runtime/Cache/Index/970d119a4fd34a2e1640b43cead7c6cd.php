...
<table border="1" cellspacing="10">
	<tr><td>套餐id</td><td>套餐名</td><td>优惠价</td><td style="cursor:pointer;" id="zengjia"><font size="3" color="red">增加</font></td></tr>

	<!-- 以下是一层 name需要你渲染上去对应的套餐id-->
	<tr ><td >1</td><td>套餐名</td><td>优惠价</td><td style="cursor:pointer;" id="xiugai" name="套餐id"><font size="3" color="red">修改</font></td><td style="cursor:pointer;" name="套餐id" id="shanchu" ><font size="3" color="red">删除</font></td><td style="cursor:pointer;" onclick="window.open('<?php echo U('Index/background/taocanxiangqing');?>');" ><font size="3" color="red" >详情及修改</font></td></tr>
	</table>
<br><br><br>
