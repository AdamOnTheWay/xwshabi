...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#sub').click(function(){
                var option = {
                    url: "<?php echo U('Index/vipCenter/handUserInfo');?>",
...
<div class="quanbu">
                ...
                <form class="temp" id='form' method="post" action="<?php echo U('Index/vipCenter/handUserInfo');?>">
                    ...
                    <div class="basicInformation">
                        ...
                        <div class="chooseContent">
                            ...
                            <div class="chooses">
                                <!--<select class="easyui-combobox" name="year" required>-->
                                ...
                                <!--</select>-->
                                <!--<select class="easyui-combobox" name="month" required>-->
                                ...
                                <!--</select>-->
                                <!--<select class="easyui-combobox" name="day" required>-->
                                    <!--<option value="1">1</option>-->
                                    <!--<option value="2">2</option>-->
                                    <!--<option value="3">3</option>-->
                                    <!--<option value="4">4</option>-->
                        ...
                        <div class="chooseContent">
                            <!-- <span>是否接受邮件</span>
                            <div class="chooses">
                                <label><input type="radio" name="isEmail" value="yesEmail" required>接受邮件</label>
                                <label><input type="radio" name="isEmail" value="noEmail" required>不接受邮件</label>
                            </div> -->
                        </div>
                    </div>
                    ...
                    <button type="button" id='sub' value="" style="background-image: url('../Public/images/vipCenter/saveButton.png');width: 80px;height: 30px;border: none;margin-left: 45px"></button>
                </form>
                <script type="text/javascript">
    ...
    <div class="navbar">
        <div class="userHead">
            ...
            function showResponse(data){
                if (data["msg"] == 1) {
                     $("#imgHead").attr('src',"/travel/steptu/"+data["path"]);
                }else{
                    alert(data["path"]);
                }
            }
