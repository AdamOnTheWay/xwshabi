                ...
                <form class="temp" id='form' method="post" action="<?php echo U('Index/vipCenter/handUserInfo');?>">
                    ...
                    <div class="basicInformation">
                        ...
                        <div class="chooseContent">
                            <span>自我介绍</span>
                            <div class="chooses">
                                <label><textarea name="comment" rows="3" cols="50" maxlength="140" onchange="this.value=this.value.substring(0, 140)" onkeydown="this.value=this.value.substring(0, 140)" onkeyup="this.value=this.value.substring(0, 140)" ><?php echo ($user["comment"]); ?></textarea></label>
                    ...
                    <button type="button" id="sub">保存资料</button>
                </form>
                <script type="text/javascript">
