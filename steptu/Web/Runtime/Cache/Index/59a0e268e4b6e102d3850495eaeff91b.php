...
<br> <br> <br>
<form action="" name="haohuajiudiansousuo" method="post">豪华酒店搜索<br>
    豪华酒店id&nbsp&nbsp<input name="haohuajiudianid" type="text" value=""><br>
    豪华酒店名&nbsp&nbsp<input name="haohuajiudianming" type="text" value=""><br>
   	豪华酒店价格&nbsp&nbsp<input name="haohuajiudianjiage" type="text" value=""><br>
   	豪华酒店所在地&nbsp&nbsp<input name="haohuajiudiansuozaidi" type="text" value=""><br>
<input type="submit" value="搜索" />
</form>
<br> <br> <br>
<table border="1" cellspacing="10">
	<tr><td>豪华酒店id</td><td>豪华酒店名</td><td>	豪华酒店价格</td><td>豪华酒店所在地</td><td>最早可入住日期</td><td>最晚可离店日期</td><td style="cursor:pointer;" id="zengjia"><font size="3" color="red">增加</font></td></tr>

	<!-- 以下是一层 name需要你渲染上去对应的套餐id-->
	<tr ><td >豪华酒店id</td><td>华酒店名</td><td>豪华酒店价格</td><td>豪华酒店所在地</td><td>最早可入住日期</td><td>最晚可离店日期</td><td style="cursor:pointer;" id="xiugai" name="套餐id"><font size="3" color="red">修改</font></td><td style="cursor:pointer;" name="套餐id" id="shanchu" ><font size="3" color="red">删除</font></td><td style="cursor:pointer;" onclick="window.open('<?php echo U('Index/background/jiudianxiangqing');?>');" ><font size="3" color="red" >详情及修改</font></td></tr>
	</table>
<br><br><br>
<div id="yonghuxinxi" style="display:none;">
<form action="" name="yonghuguanli" id="yonghuguanli" method="post">
	  <div>豪华酒店id:&nbsp&nbsp</div><br>
   	豪华酒店名&nbsp&nbsp<input name="haohuajiudianming" type="text" value=""><br>
   	豪华酒店价格&nbsp&nbsp<input name="haohuajiudianjiage" type="text" value=""><br>
    豪华酒店所在地&nbsp&nbsp<br>
      <div class="info">
	<div>
