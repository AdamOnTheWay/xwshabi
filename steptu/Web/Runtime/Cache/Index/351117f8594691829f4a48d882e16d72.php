...
<head>
    ...
    $(function(){
        ...
        $("#adult,#child").change(function(){
            ...
            $.post("<?php echo U('Index/package/countMoney','','');?>",{adult:$("#adult").val(),child:$("#child").val(),id:1},function(data){
                $('.money').html("￥" + data);
                $("#total").val(data);
            })
        });
...
//    function height(){
//        var height1=$("realContainer").offsetHeight;
//        document.all.mainbox.style.width="height1";
//    }
    </script>
</head>
<body>
<div class="quanbu">
    ...
    <div class="container">
        ...
        <div class="realContainer">
            ...
            <form class="orderContainer" method="post" action="<?php echo U('Index/package/order_2','','');?>">
                <div class="travelInformation">
                    <span>出游信息</span>
                    <input type="hidden" value="0" name="money" id="total">
                    <input type="hidden" value="<?php echo ($data["id"]); ?>" name="id">
                    <input type="hidden" value="<?php echo ($data["name"]); ?>" name="title">
                    <table class="table">
                        <tr>
                            <td>产品名称：</td>
                        ...
                        <tr>
                            <td>联系人：</td>
                            <td><label><input name="name" type="text" required style="width: 200px" id="name"></label></td>
                        </tr>
                        <tr>
                            <td>手机：</td>
