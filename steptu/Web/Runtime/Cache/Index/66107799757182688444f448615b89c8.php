    ...
    <div class="container">
        ...
        <div class="mainbox">
            ...
            <div class="theme-popbod dform">
                <form class="theme-signin" name="form" style="padding-top: 10%;padding-left: 0.5%" action="#" method="post">
                    <ol>
                        <li><strong>确认手机号：</strong><label><input class="ipt" type="tel" size="20" required></label></li>
                        <li><strong>校验码：</strong><label><input class="ipt" type="number" size="20" style="width: 20%">&nbsp;&nbsp;<input class="btn btn-active" type="submit" value="发送至手机"></label></li>
                       </ol>
                    <br/><br/>
                    <input class="btn btn-primary" type="submit" name="submit" value=" 提    交 " style="left: 82px">
                </form>
            </div>
        </div>
    </div>
