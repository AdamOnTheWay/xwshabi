// JavaScript Document
function changecity(){
 index = yonghuguanli.sf.options.selectedIndex-1;
 yonghuguanli.city.length = city[index].length;
 for(var i = 0;i<city[index].length;i++)
  {
   var text = city[index][i].split("-");
   yonghuguanli.city.options[i].text = text[0];
   yonghuguanli.city.options[i].value =text[1];
  }
}
